        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            using (SelectionForm selectionForm = new SelectionForm())
            {
                ...
                if (selectionForm.checkedListBox.CheckedItems.Count != 0)
                {
                    ...
                    try
                    {
                        bomExport(doc, ref message, baseFolder, result2, schedules, selected);
                    }
                    catch (Exception ex)
                    {
...
#pragma warning restore CS0168 // Variable is declared but never used
        ...
        public Result bomExport(Document doc, ref string message, string baseFolder, DialogResult result, 
...
#pragma warning restore CS0168 // Variable is declared but never used
        ...
        public Result exportSchedulesToCSV(Document doc, ref string message, string baseFolder)
        {
            List<ViewSchedule> schedules;//list of scheuled
            List<ViewSchedule> selected = new List<ViewSchedule>();  //List of selected schedules
            try
